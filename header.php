...
if (!isset($_SESSION['accNumber'])) {
    header("location: http://my.aseshopping.com/login.php");
}
?>
...
<html>
   <head>
      ...
      <title>ASEshopping - Personal delivery from USA, UK, Turkey, Germany to Baku</title>
              ...
              <div id="sidebar-menu">
                <ul>
                  ...
                  <li class="has_sub">
                    ...
                    <li>
                      <a href="orders.php" class="waves-effect <?php echo $orders_sub;?>">
                  ...
                  <li>
                    <a href="ask_buy.php" class="waves-effect <?php echo $ask_buy_sub;?>">
                      <i class="md  md-add-shopping-cart">
                      </i>
                      <span>
                        Ask to buy 
                      </span>

			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						...
						<?php echo $_SESSION['username'].", xoş gəlmisiniz!";?></span>
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li>
								<a href="profile.php">
								<i class="icon-user"></i> Mənim profilim </a>
							</li>
							<li>
								<a href="logout.php">
								<i class="icon-key"></i> Çıxış</a>
							</li>
						</ul>
					</li>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<i class="icon-docs"></i>
					<span class="title">Ödəmələr</span>
					</a>
				</li>
				<li>
					<a href="howto.php">
...
Sizə uğurlar və yaxşı alış-veriş arzu edirik,<br/>
ASEshopping 
	</div>
	<br/>
				Amerikada çatdırılma üçün ünvanınız: <br/><br/>
<address id="addr">

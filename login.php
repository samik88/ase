...
<div style="text-align:right"><a href="http://aseshopping.com">x</a></div>
	...
	<form class="login-form" action="login.php" method="post">
		...
		<div class="form-actions">
			<button type="submit" class="btn btn-success uppercase">Зайти</button>
			<a href="http://my.aseshopping.com/reset_pass.php"  id="forget-password" class="forget-password">Забыли пароль?</a>
		</div>
		<div class="create-account">
			<p>
				<a href="register.php" id="register-btn" class="uppercase">Создать профиль?</a>
			</p>
		</div>
	</form>
</div>

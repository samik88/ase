                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <br/>
                                                <textarea name="warning" id="warning" class="form-control"><?php echo trim($row[ 'warning']);?></textarea>
                                                <br/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <span class="btn btn-info  waves-effect waves-light" style="float:right"><a href="usa_price.php" style="color:white">PRICE TABLE</a></span>
                                            </div>
                                        </div>

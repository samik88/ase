...
if (isset($_POST['passformsubmitted'])) {
    ...
    if(isset($_POST['Email'])){
             ...
             if(strlen($key) == 32){             
             $message .= WEBSITE_URL . '/admin/reset.php?email=' . urlencode($_POST['Email']) . "&key=".$key;
    ...
    echo "   Enter your <b>Email</b> and instructions will be sent to you!";
}
...
?>
        ...
        <!-- Main  -->
        <script src="a../ssets/js/jquery.min.js"></script>

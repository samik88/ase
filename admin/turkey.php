                ...
                TURKEY 
                        ...
                        <div class="panel-body contacts">
                            <form action="#" method="POST" id="country_form">
                                <div class="row">
                                    <div id="result">
                                        <?php if($result==1){echo "<span class='text-success'>Info is updated</span>";}?>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <br/>
                                                <textarea name="attention" id="attention" class="form-control">
                                                    <?php echo trim($row[ 'warning']);?>
                                                </textarea>
                                                <br/>
                                                <label>Reminder:</label>
                                                <textarea name="reminder" id="reminder" class="form-control">
                                                    <?php echo trim($row[ 'reminder']);?>
                                                </textarea>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <span class="btn btn-info  waves-effect waves-light" style="float:right"><a href="turkey_price.php"  style="color:white">PRICE TABLE</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
